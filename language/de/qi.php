...
$lang = array_merge($lang, array(
	...
	'DBMS' => 'Datenbank-Typ',
	'DBMS_EXPLAIN' => 'Dein Datenbanksystem. Wenn du dir unsicher bist, versuch es mit MySQL.',
	...
	'QI_MAIN' => 'Hauptseite',
	'QI_MAIN_ABOUT' => 'Hier kannst du ein neues Board installieren.<br /><br />„Name der Datenbank und des Verzeichnisses des Boards“ ist das einzige Feld, das du ausfüllen musst, die anderen Felder werden mit den Standardwerten der <em>includes/qi_config.php</em> befüllt.<br /><br />Klick auf „Erweiterte Optionen“, um weitere Optionen anzuzeigen.',
	...
	'WHY' => 'Wieso?',
	'WHY_EXPLAIN' => 'Wenn du viele Modifikationen erstellst, hast du (auch schon in phpBB 2) das Problem, dass du nicht alle Anpassungen in einer einzigen phpBB-Installation verwenden kannst. Daher ist am besten, wenn du getrennte Installationen verwendest. Allerdings ist es sehr aufwändig, die ganzen Dateien zu kopieren und jedes Mal die Installationsvorgänge durchzuführen. Um diesen Vorgang zu beschleunigen, wurde QuickInstall geboren.',
));
